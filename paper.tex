...
assign a higher weight to the positives. For BSL-MTL, we tried $k$ = 5, ... 100 and the regularization parameter controlling the norm of $U$ and $V$ was tuned over the range $\lambda$=$\{1 ... 10^{-3}\}$. For each task $t$, $\sigma_t$ was varied over the values $10^{-3}, ... 10^{-6}$ and
...
\begin{figure}
\centering
\includegraphics[scale=0.35, trim = 0 0.2cm 0 0.5cm]{fig2-eps-converted-to.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.23, trim = 0 5.6cm 0 6cm]{pca_with_clusters.pdf}
