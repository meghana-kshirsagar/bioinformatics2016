...
\ffigbox[0.3\textwidth]{%
%trim option's parameter order: left bottom right top
%\includegraphics[scale=0.35, trim = 0.2 9.2cm 4cm 0]{fig1-eps-converted-to.pdf}
\includegraphics[scale=0.32, trim = 0 0.2cm 0 0.5cm]{fig2-eps-converted-to.pdf}
}
{
...
\includegraphics[scale=0.21, trim = 0 5.6cm 0 6cm]{pca_with_clusters.pdf}
}
{
