...
\author{Meghana Kshirsagar$^{1*}$, Keerthiram Murugesan$^{2}$,\\  Jaime G. Carbonell$^{2}$, Judith Klein-Seetharaman$^{3}$
\thanks{$^{1}$Memorial Sloan Kettering Cancer Center, 1275 York Ave., NY 10021}
\thanks{$^{2}$Language Technologies Institute, Carnegie Mellon Univ., 5000 Forbes Ave., Pittsburgh PA 15213, USA}
\thanks{$^{3}$Metabolic \& Vascular Health, Warwick Medical School, Univ. of Warwick, Coventry, UK}
}
...
\textbf{Contact:}
\href{mkshirsa@cs.cmu.edu}{meghana.ksagar@gmail.com}
\end{abstract}
...
\includegraphics[scale=0.34, trim = 0 0 0 0]{Kshirsagar.Fig_1.eps}
...
\begin{figure}
\includegraphics[scale=0.25, trim = 1.1cm 0.9cm 0 0]{pca_bslmtl_with_clusters.eps}
...
\begin{center}
\includegraphics[scale=0.25, trim = 2cm 1.5cm 1cm 1.5cm]{Kshirsagar.Fig_3a.eps}
\end{center}
\end{minipage}
&
\begin{minipage}{0.55\textwidth}
\begin{center}
\includegraphics[scale=0.35, trim = 2cm 1.5cm 1cm 1.5cm]{Kshirsagar.Fig_3b.eps}
\end{center}
\end{minipage}
\end{tabular}
...
number of HP PPIs$^a$ (positives) & 848 & 981 & 90 \\\hline
...
UniProtKB across strains$^b$ & & & \\ \hline
number of negatives & 84800 & 98100 & 9000 \\\hline
density of observed graph$^c$ (as \%) & .15 & .60 & .20 \\\hline
\multicolumn{4}{l}{\scriptsize{$^a$ HP PPI: host-pathogen protein protein interactions}}\\
\multicolumn{4}{l}{\scriptsize{$^c$ Density = (no. of positives + no. of negatives)/ total number of possible edges. The denominator was computed considering all}} \\
\multicolumn{4}{l}{\scriptsize{\hspace{0.1cm} proteins from all strains of the virus and $\approx$ 100,000 human proteins.}}\\
\multicolumn{4}{l}{\scriptsize{$^b$ this is the number of `reviewed' proteins on UniProtKB from all strains in our data}} \\ \hline
\end{tabular}
\end{footnotesize}
\end{table}
...
cluster 1 (ebola only) & mRNA (guanine-N7-)-methyltransferase activity; RNA-directed RNA polymerase activity; ATP binding \\ \hline
cluster 2 (hepatitis \& & host cell endoplasmic reticulum membrane; host cell lipid particle; induction by virus \\ 
influenza proteins) &  of host autophagy; host cell mitochondrial membrane; suppression by virus of host STAT1 activity \\ \hline
