...
\begin{center}
\includegraphics[scale=0.3, trim = 0.7cm 0.7cm 0.7cm 0.7cm]{flavinet.pdf}
\end{center}
\end{minipage}
\\
\begin{minipage}{\textwidth}
\begin{center}
\includegraphics[scale=0.35, trim = 0.5cm 0.5cm 0.5cm 0.5cm]{flunet.pdf}
\end{center}
\end{minipage}
\end{tabular}
