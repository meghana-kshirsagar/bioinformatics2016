...
\begin{figure}
\begin{tabular}{>{\centering}m{0.5cm}c}
...
\begin{center}
\includegraphics[scale=0.22, trim = 1cm 1.5cm 1cm 1.5cm]{flavinet.eps}
\end{center}
\end{minipage}
\\
(b) &
\begin{minipage}{0.9\textwidth}
\begin{center}
\includegraphics[scale=0.33, trim = 1cm 1.5cm 1cm 1.5cm]{flunet.eps}
\end{center}
\end{minipage}
\end{tabular}
